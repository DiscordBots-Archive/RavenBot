exports.run = async (client, message, args) => {
    ...
    if (message.channel.name !== 'bot-commands' & message.channel.type !== 'dm' & message.channel.name !== 'change-log' & message.channel.name !== 'read-me' & message.channel.name !== 'audio-commands') {
